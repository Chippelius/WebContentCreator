...
public class HtmlEscape {
	...
	/**
	 * Method for html escaping a String, for use in a textarea <br>
	 * <br>
	 * Edited by Leo Köberlein
	 * @param original The String to escape
	 * @return The escaped String
	 */
	public static String escapeTextArea(String original)
	{
		//Order of method calls edited because the '&' in '&gt;' and '&lt;' 
		//from escapeTags got escaped in escapeSpecial
		return escapeTags(escapeSpecial(original));
	}

	/**
	 * Normal escape function, for Html escaping Strings <br>
	 * <br>
	 * Edited by Leo Köberlein
